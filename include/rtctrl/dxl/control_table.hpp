...
inline constexpr Reg kDriveMode{10, 1};
inline constexpr Reg kOperatingMode{11, 1};
inline constexpr Reg kSecondaryId{12, 1};
inline constexpr Reg kProtocolType{13, 1};
inline constexpr Reg kHomingOffset{20, 4};
inline constexpr Reg kMovingThreshold{24, 4};
inline constexpr Reg kTemperatureLimit{31, 1};
inline constexpr Reg kMaxVoltageLimit{32, 2};
inline constexpr Reg kMinVoltageLimit{34, 2};
inline constexpr Reg kPwmLimit{36, 2};
...
inline constexpr Reg kExternalPortMode1{56, 1};
inline constexpr Reg kExternalPortMode2{57, 1};
inline constexpr Reg kExternalPortMode3{58, 1};
inline constexpr Reg kStartupConfiguration{60, 1};
inline constexpr Reg kShutdown{63, 1};
...
inline constexpr Reg kFeedforward2ndGain{88, 2};
inline constexpr Reg kFeedforward1stGain{90, 2};
