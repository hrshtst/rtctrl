...
- [Gravity demo](hardware/gravity-demo.md): the simplified floating-arm
  demonstration with customizable torque constants; the
  experimental-calibration policy, never acceptance evidence
