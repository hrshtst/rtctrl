...
controllers; cited by `docs/records/history.md`,
`docs/hardware/bringup.md`, and the theory chapters. `track9.csv` was
...
(`docs/records/history.md`, M-GC3): the vendor-scale
